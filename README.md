...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w9tbmm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w9tbmm.containers.anotherwebservice.com/
...
```
git clone git@github.com:stg8/container-w9tbmm.git
cd container-w9tbmm
```
...
```
docker attach container-w9tbmm
```
